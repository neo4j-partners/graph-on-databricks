...
- `uv` installed.
- The Databricks CLI installed and authenticated to a profile.
- A `finance-genie/.env` (the parent directory) with the Aura connection plus the
  Databricks profile and warehouse used to create the Silver tables:
