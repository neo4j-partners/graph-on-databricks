# Fraud Signal Workbench Agent Guide

The repository folder is `fraud-signal-workbench`. The internal Python package
and stable deployed resource identifiers remain `graph_fraud_analyst` and
...
| `Dependencies.Neo4j` | `neo4j.Driver` | Connection-pooled Neo4j driver supplied by the application lifespan. |
