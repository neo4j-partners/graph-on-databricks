...
def main() -> None:
    ...
    steps = [
        ...
        Step("verify fraud patterns in existing data", python_cmd("diagnostics/verify_fraud_patterns.py", "--input", "../data"), 900),
        Step("upload existing data and create base tables", ["./upload_and_create_tables.sh"], 3600),
        Step("create or reconcile canonical Genie spaces", python_cmd("setup/provision_genie_spaces.py"), 1800),
